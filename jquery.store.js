(function( $ ) {
	...
	$.Shop.prototype = {
		init: function() {
			...
			this.currency = "NGN"; // HTML entity of the currency to be displayed in the layout
			this.currencyString = "NGN"; // Currency symbol as textual string
			this.paypalCurrency = "NGN"; // PayPal's currency code
